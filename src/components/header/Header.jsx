...
const Header = () => {
    return (
        <header className="section-outer section-header">
            <div className="section-inner section-inner__wide">
                <div className="main-navigation">
                    <a className="logo" href="#"></a>
                    <nav className="nav">
                        <ul className="nav-wrapper">
                            <li className="nav-wrapper__item">
                                <a href="#" className="nav-wrapper__item-link nav-wrapper__item-link--active">Home</a>
                            </li>
                            <li className="nav-wrapper__item">
                                <a href="#" className="nav-wrapper__item-link">Blog</a>
                            </li>
                            <li className="nav-wrapper__item">
                                <a href="#" className="nav-wrapper__item-link">Features</a>
                            </li>
                            <li className="nav-wrapper__item">
                                <a href="#" className="nav-wrapper__item-link">Pricing</a>
                            </li>
                            <li className="nav-wrapper__item">
                                <a href="#" className="nav-wrapper__item-link">Documentation</a>
                            </li>
                        </ul>
                    </nav>
